...
var _ crypto.Signature = (*EdDSAEd25519Signature)(nil)
...
func (s *EdDSAEd25519Signature) Equal(other crypto.Signature) bool {
	if s == nil || other == nil {
		return false
	}
...
func (s *EdDSAEd25519Signature) Verify(pubkey crypto.PublicKey, data []byte) bool {
...
func EdDSAEd25519SignatureFromBytes(b []byte) (crypto.Signature, error) {
...
func EdDSAEd25519SignatureFromString(s string) (crypto.Signature, error) {
