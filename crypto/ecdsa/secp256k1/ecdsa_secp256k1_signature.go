...
func (s *ECDSASecp256k1Signature) Equal(other crypto.Signature) bool {
	if s == nil || other == nil {
		return false
	}
...
func (s *ECDSASecp256k1Signature) Verify(pubkey crypto.PublicKey, data []byte) bool {
...
func ECDSASecp256k1SignatureFromBytes(b []byte) (crypto.Signature, error) {
...
func ECDSASecp256k1SignatureFromString(s string) (crypto.Signature, error) {
