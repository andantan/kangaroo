...
func (k *ECDSASecp256k1PublicKey) Address(deriver hash.AddressDeriver) hash.Addressable {
...
func ECDSASecp256k1PublicKeyFromString(s string) (key.PublicKey, error) {
